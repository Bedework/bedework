...
Up to now there has been a UI field to set the calendar collection e.g. "/public/cals/MainCal" for events. This has been completely removed. It's unnecessary and caused toomany problems.
