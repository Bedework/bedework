...
You probably want latest. The dev version is obviously for development adn can be very unstable. The pre-release version is ther only for testing of the install script.
...
In reality - installing ES is relatively simple. It may be easier to install the appropriate service for your system. Downloads can be found at https://www.elastic.co/downloads/past-releases/elasticsearch-7-2-0
