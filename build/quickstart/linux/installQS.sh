...
installSources() {
  ...
  if [ "$version" == "dev" ] ; then
    ...
    cloneRepoBranch 4.0.3 bw-access "$1"
    cloneRepoBranch 4.0.4 bw-caldav "$1"
    cloneRepoBranch 3.12.1 bw-calendar-client "$1"
    ...
    cloneRepoBranch 4.0.3 bw-notifier "$1"
    cloneRepoBranch 4.0.5 bw-self-registration "$1"
    cloneRepoBranch 4.0.1 bw-synch "$1"
    cloneRepoBranch 4.0.2 bw-timezone-server "$1"
